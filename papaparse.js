  ...
  var s,
    ...
    unparse: function unparse(e, t) {
      ...
      if (Array.isArray(e)) {
        ...
        if ("object" == _typeof(e[0])) return o(a(e[0]), e, r);
      } else if ("object" == _typeof(e)) return "string" == typeof e.data && (e.data = JSON.parse(e.data)), Array.isArray(e.data) && (e.fields || (e.fields = e.meta && e.meta.fields), e.fields || (e.fields = Array.isArray(e.data[0]) ? e.fields : a(e.data[0])), Array.isArray(e.data[0]) || "object" == _typeof(e.data[0]) || (e.data = [e.data])), o(e.fields || [], e.data || [], r);
